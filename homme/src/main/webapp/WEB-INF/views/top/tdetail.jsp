 ...
 $(function(){
		...
		$("#Size").change(function(){	
			...
			if($("#Size option:selected").val()=='s'){				
				$(".tshirtSize").append("<div class = 'product_option_S'>"+
						"<div class = 'Ssize'>S</div>"+
							"<div class = 'Scount'>"+scount+"</div>"+
							"<div class = 'Splus'>+</div>"+
							"<div class = 'Sminus'>-</div>"+
							"<div class = 'Sprice'>"+${tdetail.tprice}+"</div>"+
			...
			if($("#Size option:selected").val()=='m'){
				$(".tshirtSize").append("<div class = 'product_option_M'>"+
						"<div class = 'Msize'>M</div>"+
							"<div class = 'Mcount'>"+mcount+"</div>"+
							"<div class = 'Mplus'>+</div>"+
							"<div class = 'Mminus'>-</div>"+
							"<div class = 'Mprice'>"+${tdetail.tprice}+"</div>"+
			...
			if($("#Size option:selected").val()=='l'){
				$(".tshirtSize").append("<div class = 'product_option_L'>"+
						"<div class = 'Lsize'>L</div>"+
							"<div class = 'Lcount'>"+lcount+"</div>"+
							"<div class = 'Lplus'>+</div>"+
							"<div class = 'Lminus'>-</div>"+
							"<div class = 'Lprice'>"+${tdetail.tprice}+"</div>"+
...
<div class="sidenav">
  ...
  <a href="#">REGISTER</a><br/><br/>
	...
	<ul id = "tshirt" class="row">
	  <li class = "col-md-12">
	   <div class = "tshirtImg" >
	 	 <c:forEach begin="1" end="${tdetail.tcount}" varStatus="st">
	 	  <img src = "${pageContext.request.contextPath }/resources/tshirtImgs/${tname}/${tname}${st.index}.jpg">
	 	 </c:forEach>
	   </div>
	  </li>
	</ul>
