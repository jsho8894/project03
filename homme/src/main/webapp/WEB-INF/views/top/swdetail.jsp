 ...
 $(function(){
		...
		$("#Size").change(function(){	
			...
			if($("#Size option:selected").val()=='s'){				
				$(".sweaterSize").append("<div class = 'product_option_S'>"+
						"<div class = 'Ssize'>S</div>"+
							"<div class = 'Scount'>"+scount+"</div>"+
							"<div class = 'Splus'>+</div>"+
							"<div class = 'Sminus'>-</div>"+
							"<div class = 'Sprice'>"+${swdetail.swprice}+"</div>"+
			...
			if($("#Size option:selected").val()=='m'){
				$(".sweaterSize").append("<div class = 'product_option_M'>"+
						"<div class = 'Msize'>M</div>"+
							"<div class = 'Mcount'>"+mcount+"</div>"+
							"<div class = 'Mplus'>+</div>"+
							"<div class = 'Mminus'>-</div>"+
							"<div class = 'Mprice'>"+${swdetail.swprice}+"</div>"+
			...
			if($("#Size option:selected").val()=='l'){
				$(".sweaterSize").append("<div class = 'product_option_L'>"+
						"<div class = 'Lsize'>L</div>"+
							"<div class = 'Lcount'>"+lcount+"</div>"+
							"<div class = 'Lplus'>+</div>"+
							"<div class = 'Lminus'>-</div>"+
							"<div class = 'Lprice'>"+${swdetail.swprice}+"</div>"+
	...
	<ul id = "sweater" class="row">
	  <li class = "col-md-12">
	   <div class = "sweaterImg" >
	 	 <c:forEach begin="1" end="${swdetail.swcount}" varStatus="st">
	 	  <img src = "${pageContext.request.contextPath }/resources/sweaterImgs/${swname}/${swname}${st.index}.jpg">
	 	 </c:forEach>
	   </div>
	  </li>
	</ul>
